...
#mb-fav-btn{position:fixed;right:1.25rem;bottom:4.4rem;z-index:60;width:2.6rem;height:2.6rem;display:flex;align-items:center;justify-content:center;border:1px solid #e5e7ec;border-radius:50%;background:#fff;color:#555;cursor:pointer;box-shadow:0 4px 16px rgb(0 0 0/.14);transition:transform .15s ease,color .15s ease}
